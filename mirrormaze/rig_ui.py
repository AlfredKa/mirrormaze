...
class RigUI(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        if is_selected({'hand_tweak.L', 'upper_arm_ik.L', 'upper_arm_parent.L', 'VIS_upper_arm_ik_pole.L', 'forearm_tweak.L.001', 'hand_fk.L', 'upper_arm_ik_target.L', 'forearm_fk.L', 'upper_arm_fk.L', 'upper_arm_tweak.L', 'hand_ik.L', 'forearm_tweak.L', 'upper_arm_tweak.L.001'}):
            emit_rig_separator()
            if is_selected({'upper_arm_parent.L', 'forearm_fk.L', 'upper_arm_fk.L', 'hand_fk.L'}):
            ...
            props = group1.operator('pose.rigify_generic_snap_sa33e8us0bb17656', text='FK->IK (hand.L)', icon='SNAP_ON')
            ...
            props = group2.operator('pose.rigify_generic_snap_bake_sa33e8us0bb17656', text='Action', icon='ACTION_TWEAK')
            props.output_bones = '["upper_arm_fk.L", "forearm_fk.L", "hand_fk.L"]'
            props.input_bones = '["upper_arm_ik.L", "MCH-forearm_ik.L", "MCH-upper_arm_ik_target.L"]'
            props.ctrl_bones = '["upper_arm_ik.L", "upper_arm_ik_target.L", "hand_ik.L"]'
            props = group2.operator('pose.rigify_clear_keyframes_sa33e8us0bb17656', text='Clear', icon='CANCEL')
            props.bones = '["upper_arm_fk.L", "forearm_fk.L", "hand_fk.L"]'
            group1 = layout.column(align=True)
            props = group1.operator('pose.rigify_limb_ik2fk_sa33e8us0bb17656', text='IK->FK (hand.L)', icon='SNAP_ON')
            ...
            props.extra_ctrls = '[]'
            group2 = group1.row(align=True)
            props = group2.operator('pose.rigify_limb_ik2fk_bake_sa33e8us0bb17656', text='Action', icon='ACTION_TWEAK')
            props.prop_bone = 'upper_arm_parent.L'
            props.fk_bones = '["upper_arm_fk.L", "forearm_fk.L", "hand_fk.L"]'
            props.ik_bones = '["upper_arm_ik.L", "MCH-forearm_ik.L", "MCH-upper_arm_ik_target.L"]'
            props.ctrl_bones = '["upper_arm_ik.L", "upper_arm_ik_target.L", "hand_ik.L"]'
            ...
            if is_selected({'upper_arm_parent.L', 'upper_arm_ik_target.L', 'hand_ik.L', 'upper_arm_ik.L'}):
                ...
                props = group2.operator('pose.rigify_limb_toggle_pole_sa33e8us0bb17656', icon='FORCE_MAGNETIC')
                props.prop_bone = 'upper_arm_parent.L'
                props.ik_bones = '["upper_arm_ik.L", "MCH-forearm_ik.L", "MCH-upper_arm_ik_target.L"]'
                props.ctrl_bones = '["upper_arm_ik.L", "upper_arm_ik_target.L", "hand_ik.L"]'
                props.extra_ctrls = '[]'
                group2.prop(pose_bones['upper_arm_parent.L'], '["pole_vector"]', text='')
                props = group1.operator('pose.rigify_limb_toggle_pole_bake_sa33e8us0bb17656', text='', icon='ACTION_TWEAK')
                props.prop_bone = 'upper_arm_parent.L'
                props.ik_bones = '["upper_arm_ik.L", "MCH-forearm_ik.L", "MCH-upper_arm_ik_target.L"]'
                props.ctrl_bones = '["upper_arm_ik.L", "upper_arm_ik_target.L", "hand_ik.L"]'
                props.extra_ctrls = '[]'
                group1 = layout.row(align=True)
                group2 = group1.split(factor=0.75, align=True)
                props = group2.operator('pose.rigify_switch_parent_sa33e8us0bb17656', text='IK Parent', icon='DOWNARROW_HLT')
                ...
                props = group1.operator('pose.rigify_switch_parent_bake_sa33e8us0bb17656', text='', icon='ACTION_TWEAK')
                props.bone = 'hand_ik.L'
                props.prop_bone = 'upper_arm_parent.L'
                props.prop_id = 'IK_parent'
                props.parent_names = '["None", "Root", "Torso", "Hips", "Chest", "Head", "shoulder.L"]'
                ...
                group1 = layout.row(align=True)
                group2 = group1.split(factor=0.75, align=True)
                props = group2.operator('pose.rigify_switch_parent_sa33e8us0bb17656', text='Pole Parent', icon='DOWNARROW_HLT')
        ...
        if is_selected({'upper_arm_fk.R', 'upper_arm_tweak.R.001', 'VIS_upper_arm_ik_pole.R', 'forearm_fk.R', 'forearm_tweak.R', 'upper_arm_ik_target.R', 'hand_ik.R', 'hand_fk.R', 'forearm_tweak.R.001', 'upper_arm_tweak.R', 'upper_arm_parent.R', 'hand_tweak.R', 'upper_arm_ik.R'}):
            emit_rig_separator()
            if is_selected({'upper_arm_fk.R', 'hand_fk.R', 'upper_arm_parent.R', 'forearm_fk.R'}):
            ...
            group1 = layout.column(align=True)
            props = group1.operator('pose.rigify_generic_snap_sa33e8us0bb17656', text='FK->IK (hand.R)', icon='SNAP_ON')
            ...
            group1 = layout.column(align=True)
            props = group1.operator('pose.rigify_limb_ik2fk_sa33e8us0bb17656', text='IK->FK (hand.R)', icon='SNAP_ON')
            ...
            if is_selected({'upper_arm_ik_target.R', 'hand_ik.R', 'upper_arm_parent.R', 'upper_arm_ik.R'}):
        ...
        if is_selected({'spine_fk.003', 'spine_fk.001', 'tweak_spine.004', 'head', 'spine_fk.002', 'tweak_spine.001', 'tweak_spine.003', 'tweak_spine.002', 'spine_fk', 'tweak_spine', 'torso', 'tweak_spine.005', 'neck', 'hips', 'chest'}):
            emit_rig_separator()
            ...
            if is_selected({'spine_fk.001', 'tweak_spine.004', 'spine_fk.002', 'tweak_spine.001', 'tweak_spine.002', 'tweak_spine.003', 'chest', 'spine_fk', 'tweak_spine', 'torso', 'hips', 'spine_fk.003'}):
                group1 = layout.row(align=True)
                group2 = group1.split(factor=0.75, align=True)
                props = group2.operator('pose.rigify_switch_parent_sa33e8us0bb17656', text='Torso Parent', icon='DOWNARROW_HLT')
                props.bone = 'torso'
        ...
        if is_selected({'foot_heel_ik.L', 'thigh_ik_target.L', 'shin_tweak.L.001', 'thigh_parent.L', 'foot_ik.L', 'toe_fk.L', 'VIS_thigh_ik_pole.L', 'thigh_tweak.L', 'shin_tweak.L', 'foot_fk.L', 'thigh_fk.L', 'toe_ik.L', 'thigh_ik.L', 'foot_tweak.L', 'foot_spin_ik.L', 'shin_fk.L', 'thigh_tweak.L.001'}):
            emit_rig_separator()
            if is_selected({'thigh_fk.L', 'shin_fk.L', 'thigh_parent.L', 'foot_fk.L', 'toe_fk.L'}):
            ...
            group1 = layout.column(align=True)
            props = group1.operator('pose.rigify_generic_snap_sa33e8us0bb17656', text='FK->IK (foot.L)', icon='SNAP_ON')
            ...
            group1 = layout.column(align=True)
            props = group1.operator('pose.rigify_limb_ik2fk_sa33e8us0bb17656', text='IK->FK (foot.L)', icon='SNAP_ON')
            ...
            group1 = layout.row(align=True)
            props = group1.operator('pose.rigify_leg_roll_ik2fk_sa33e8us0bb17656', text='IK->FK With Roll (foot.L)', icon='SNAP_ON')
            props.prop_bone = 'thigh_parent.L'
            props.fk_bones = '["thigh_fk.L", "shin_fk.L", "foot_fk.L", "toe_fk.L"]'
            props.ik_bones = '["thigh_ik.L", "MCH-shin_ik.L", "MCH-thigh_ik_target.L"]'
            props.ctrl_bones = '["thigh_ik.L", "thigh_ik_target.L", "foot_ik.L"]'
            ...
            props = group1.operator('pose.rigify_leg_roll_ik2fk_bake_sa33e8us0bb17656', text='', icon='ACTION_TWEAK')
            props.prop_bone = 'thigh_parent.L'
            props.fk_bones = '["thigh_fk.L", "shin_fk.L", "foot_fk.L", "toe_fk.L"]'
            props.ik_bones = '["thigh_ik.L", "MCH-shin_ik.L", "MCH-thigh_ik_target.L"]'
            props.ctrl_bones = '["thigh_ik.L", "thigh_ik_target.L", "foot_ik.L"]'
            ...
            props.extra_ctrls = '["foot_heel_ik.L", "foot_spin_ik.L"]'
            props.heel_control = 'foot_heel_ik.L'
            if is_selected({'foot_heel_ik.L', 'thigh_ik.L', 'toe_ik.L', 'thigh_ik_target.L', 'foot_ik.L', 'thigh_parent.L', 'foot_spin_ik.L'}):
        ...
        if is_selected({'shin_tweak.R', 'foot_tweak.R', 'foot_ik.R', 'thigh_ik.R', 'thigh_fk.R', 'thigh_ik_target.R', 'toe_ik.R', 'thigh_tweak.R', 'foot_fk.R', 'thigh_parent.R', 'VIS_thigh_ik_pole.R', 'thigh_tweak.R.001', 'foot_heel_ik.R', 'shin_tweak.R.001', 'shin_fk.R', 'toe_fk.R', 'foot_spin_ik.R'}):
            emit_rig_separator()
            if is_selected({'foot_fk.R', 'thigh_parent.R', 'shin_fk.R', 'thigh_fk.R', 'toe_fk.R'}):
            ...
            group1 = layout.column(align=True)
            props = group1.operator('pose.rigify_generic_snap_sa33e8us0bb17656', text='FK->IK (foot.R)', icon='SNAP_ON')
            ...
            group1 = layout.column(align=True)
            props = group1.operator('pose.rigify_limb_ik2fk_sa33e8us0bb17656', text='IK->FK (foot.R)', icon='SNAP_ON')
            ...
            group1 = layout.row(align=True)
            props = group1.operator('pose.rigify_leg_roll_ik2fk_sa33e8us0bb17656', text='IK->FK With Roll (foot.R)', icon='SNAP_ON')
            props.prop_bone = 'thigh_parent.R'
            props.fk_bones = '["thigh_fk.R", "shin_fk.R", "foot_fk.R", "toe_fk.R"]'
            props.ik_bones = '["thigh_ik.R", "MCH-shin_ik.R", "MCH-thigh_ik_target.R"]'
            props.ctrl_bones = '["thigh_ik.R", "thigh_ik_target.R", "foot_ik.R"]'
            ...
            props.extra_ctrls = '["foot_heel_ik.R", "foot_spin_ik.R"]'
            props.heel_control = 'foot_heel_ik.R'
            if is_selected({'thigh_parent.R', 'foot_heel_ik.R', 'toe_ik.R', 'thigh_ik_target.R', 'foot_ik.R', 'thigh_ik.R', 'foot_spin_ik.R'}):
...
def register():
    ...
    bpy.utils.register_class(POSE_OT_rigify_leg_roll_ik2fk)
    bpy.utils.register_class(POSE_OT_rigify_leg_roll_ik2fk_bake)
...
def unregister():
    ...
    bpy.utils.unregister_class(POSE_OT_rigify_leg_roll_ik2fk)
    bpy.utils.unregister_class(POSE_OT_rigify_leg_roll_ik2fk_bake)
